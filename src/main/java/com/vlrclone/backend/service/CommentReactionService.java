...
public class CommentReactionService {
     ...
     */
    @Transactional
    public void react(Long commentId, String username, ReactionType reactionType) {

        Comment comment = commentRepository.findById(commentId)
                .orElseThrow(() -> new IllegalArgumentException("Comment not found"));

        Optional<CommentReaction> existing =
                reactionRepository.findByCommentIdAndUsername(commentId, username);
     ...
     */
    @Transactional
    public void removeReaction(Long commentId, String username) {
        reactionRepository.findByCommentIdAndUsername(commentId, username)
